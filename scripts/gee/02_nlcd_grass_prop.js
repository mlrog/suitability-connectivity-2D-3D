// =============================================================
// NLCD 2021 Grassland/Herbaceous — Proportion at 100 m
// =============================================================
// Purpose: Calculates the proportion of NLCD class 71
//          (Grassland/Herbaceous) within each 100 m pixel
...
//     NLCD2021_Grass_Prop_100m_LA_UTM11.tif
...
// NLCD class to analyze (71 = Grassland/Herbaceous)
var NLCD_CLASS = 71;
...
// =============================================================
// GRASS PROPORTION (NLCD CLASS 71)
// =============================================================

// Create a binary mask: 1 where NLCD == class 71, else 0
var grassBinary = nlcdReprojected.eq(NLCD_CLASS)
  .rename('grass')
  .clip(studyBoundary);

// Multiply binary mask by pixel area to get m² of class 71
// within each 30 m cell
var grassArea = grassBinary.multiply(pixelArea);

// Aggregate class 71 area to 100 m (numerator)
var grassArea100m = grassArea.reduceResolution({
  reducer: ee.Reducer.sum(),
  maxPixels: 4096
});

// Calculate proportion: class 71 area / total cell area
// Output range: 0 (none) to 1 (entirely grassland/herbaceous)
var grassProp100m = grassArea100m
  .divide(totalArea100m)
  .rename('grass_prop_100m')
...
var rangeCheck = grassProp100m.reduceRegion({
  reducer: ee.Reducer.minMax(),
  geometry: studyBoundary.geometry(),
  scale: OUTPUT_SCALE,
  maxPixels: 1e13
});
print('QA — Grass proportion range (expect 0–1):', rangeCheck);
...
Map.addLayer(
  ...
  'QA — NLCD Class 71 binary (30 m)'
);

Map.addLayer(
  grassProp100m,
  { min: 0, max: 1, palette: ['white', 'green'] },
  'QA — Grass proportion (100 m)'
);
...
Export.image.toDrive({
  image: grassProp100m,
  description: 'NLCD2021_Grass_Prop_100m_LA_UTM11',
